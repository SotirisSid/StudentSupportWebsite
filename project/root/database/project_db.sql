...
INSERT INTO "USER" ("id", "username", "fName", "lName", "password") VALUES
    (0, "thegreatestadmin", "Sinus", "Lebastian", "yJ3GHhWNxuBS2CV3"), --ADMIN
    (1, "prafar", "Pranav", "Farley", "mAKfWFCY8x2U2Gte"), --PROF
    (2, "anmac", "Anisha", "Macdonald", "YwfqsH7c9k4DXjCB"), --STUD
    (3, "elihaas", "Elisabeth", "Haas", "82ZGWDMSmmDmnLV3"), --STUD
    (4, "t.hurst", "Teresa", "Hurst", "jHBH8ZESXcXkKVF6"), --PROF
    (5, "eboni.l", "Eboni", "Lees", "9fsv82M8eSjFyFZU"), -- STUD
    (6, "ellaheb", "Ella-Grace", "Hebert", "d5eYLU68QfvRB2Sy"); --STUD
